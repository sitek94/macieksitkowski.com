...
import HeaderImage from '../../images/projects-hero.svg'
...
export default function RemoteProjectsPage(props) {
  return <RemoteProjects {...props} />
}
...
function RemoteProjects({data: {projects}}) {
...
export const remoteProjectsQuery = graphql`
  query {
    projects: allMdx(
